export default {
	...
	apps: {
		...
		prospectly: { name: 'Prospectly', desc: 'Prospection B2B IA', tabFinder: 'Finder', tabIcp: 'ICP', tabEmails: 'Emails', tabFollowup: 'Suivi', tabScript: 'Script Appel', tabObjections: 'Objections', tabLinkedin: 'LinkedIn', tabSaved: 'Sauvegardés' },
		aiworksuite: { name: 'AIWorkSuite', desc: 'Productivité Freelance', teams: 'Équipes IA', invoice: 'Facture', proposal: 'Proposition', contract: 'Contrat', time: 'Temps', rate: 'Tarif', crm: 'CRM', teamName: 'Nom de l\'\u00e9quipe', teamProject: 'Contexte du projet', teamProjectPh: 'Décrivez le projet sur lequel cette équipe travaillera...', createAITeam: 'Créer une équipe IA', detectingRoles: 'Détection des rôles...', openChat: 'Ouvrir le chat', messageTeam: 'Message à l\'\u00e9quipe...', agentsThinking: 'Les agents réfléchissent...', teamsEmpty: 'Créez votre première équipe IA pour commencer.', clientName: 'Nom du client', services: 'Services rendus', totalAmount: 'Montant total', dueDate: 'Date d\'\u00e9chéance', generate: 'Générer', projectDesc: 'Description du projet', budget: 'Fourchette de budget', timeline: 'Délais', projectScope: 'Projet / Portée', ratePayment: 'Tarif / Paiement', scopeNotes: 'Notes de portée', annualIncome: 'Revenu annuel souhaité', billableWeeks: 'Semaines facturables/an', billableHours: 'Heures facturables/semaine', overheadPct: 'Frais généraux % (impôts, outils...)', calculateRate: 'Calculer le tarif', copy: 'Copier', crmNewClient: 'Nouveau client', crmClientName: 'Nom', crmClientCompany: 'Entreprise', crmClientEmail: 'Email', crmClientPhone: 'Téléphone', crmClientNotes: 'Notes', crmPipeline: 'Pipeline', crmStageNew: 'Nouveau', crmStageContacted: 'Contacté', crmStageQualified: 'Qualifié', crmStageProposal: 'Proposition', crmStageNegotiation: 'Négociation', crmStageWon: 'Gagné', crmStageLost: 'Perdu', crmNoClients: 'Aucun client. Créez votre premier client.', crmChatPlaceholder: 'Interrogez sur ce client...', crmChatTitle: 'Chat IA', crmTabData: 'Données', crmTabProposals: 'Propositions', crmDeleteConfirm: 'Supprimer ce client ?', crmMarkWon: 'Marquer comme gagné', crmMarkLost: 'Marquer comme perdu', crmAddNote: 'Ajouter une note', crmSaveNote: 'Enregistrer la note' },
