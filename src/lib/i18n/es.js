export default {
	...
	apps: {
		...
		aiworksuite: { name: 'AIWorkSuite', desc: 'Productividad Freelance', teams: 'Equipos IA', invoice: 'Factura', proposal: 'Propuesta', contract: 'Contrato', time: 'Tiempo', rate: 'Tarifa', crm: 'CRM', teamName: 'Nombre del equipo', teamProject: 'Contexto del proyecto', teamProjectPh: 'Describe el proyecto en el que trabajará este equipo...', createAITeam: 'Crear Equipo IA', detectingRoles: 'Detectando roles...', openChat: 'Abrir Chat del Equipo', messageTeam: 'Mensaje al equipo...', agentsThinking: 'Los agentes están pensando...', teamsEmpty: 'Crea tu primer equipo IA para comenzar.', clientName: 'Nombre del cliente', services: 'Servicios realizados', totalAmount: 'Monto total', dueDate: 'Fecha de vencimiento', generate: 'Generar', projectDesc: 'Descripción del proyecto', budget: 'Rango de presupuesto', timeline: 'Plazo', projectScope: 'Proyecto / Alcance', ratePayment: 'Tarifa / Pago', scopeNotes: 'Notas de alcance', annualIncome: 'Ingreso anual deseado', billableWeeks: 'Semanas facturables/año', billableHours: 'Horas facturables/semana', overheadPct: 'Gastos % (impuestos, herramientas...)', calculateRate: 'Calcular tarifa', copy: 'Copiar', crmNewClient: 'Nuevo cliente', crmClientName: 'Nombre', crmClientCompany: 'Empresa', crmClientEmail: 'Email', crmClientPhone: 'Teléfono', crmClientNotes: 'Notas', crmPipeline: 'Pipeline', crmStageNew: 'Nuevo', crmStageContacted: 'Contactado', crmStageQualified: 'Calificado', crmStageProposal: 'Propuesta', crmStageNegotiation: 'Negociación', crmStageWon: 'Cerrado', crmStageLost: 'Perdido', crmNoClients: 'No hay clientes. Crea tu primer cliente para empezar.', crmChatPlaceholder: 'Pregunta sobre este cliente...', crmChatTitle: 'Chat IA', crmTabData: 'Datos', crmTabProposals: 'Propuestas', crmDeleteConfirm: '¿Eliminar este cliente?', crmMarkWon: 'Marcar como ganado', crmMarkLost: 'Marcar como perdido', crmAddNote: 'Añadir nota', crmSaveNote: 'Guardar nota' },
