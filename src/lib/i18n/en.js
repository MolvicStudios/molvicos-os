export default {
	...
	apps: {
		...
		aiworksuite: { name: 'AIWorkSuite', desc: 'Freelance Productivity', teams: 'AI Teams', invoice: 'Invoice', proposal: 'Proposal', contract: 'Contract', time: 'Time', rate: 'Rate', crm: 'CRM', teamName: 'Team Name', teamProject: 'Project Context', teamProjectPh: 'Describe the project this team will work on...', createAITeam: 'Create AI Team', detectingRoles: 'Detecting roles...', openChat: 'Open Team Chat', messageTeam: 'Message the team...', agentsThinking: 'Agents are thinking...', teamsEmpty: 'Create your first AI team to get started.', clientName: 'Client Name', services: 'Services Rendered', totalAmount: 'Total Amount', dueDate: 'Due Date', generate: 'Generate', projectDesc: 'Project Description', budget: 'Budget Range', timeline: 'Timeline', projectScope: 'Project / Scope', ratePayment: 'Rate / Payment', scopeNotes: 'Scope Notes', annualIncome: 'Desired Annual Income', billableWeeks: 'Billable Weeks/Year', billableHours: 'Billable Hours/Week', overheadPct: 'Overhead % (taxes, tools...)', calculateRate: 'Calculate Rate', copy: 'Copy', crmNewClient: 'New Client', crmClientName: 'Name', crmClientCompany: 'Company', crmClientEmail: 'Email', crmClientPhone: 'Phone', crmClientNotes: 'Notes', crmPipeline: 'Pipeline', crmStageNew: 'New', crmStageContacted: 'Contacted', crmStageQualified: 'Qualified', crmStageProposal: 'Proposal', crmStageNegotiation: 'Negotiation', crmStageWon: 'Won', crmStageLost: 'Lost', crmNoClients: 'No clients yet. Create your first client to get started.', crmChatPlaceholder: 'Ask about this client...', crmChatTitle: 'AI Chat', crmTabData: 'Data', crmTabProposals: 'Proposals', crmDeleteConfirm: 'Delete this client?', crmMarkWon: 'Mark as won', crmMarkLost: 'Mark as lost', crmAddNote: 'Add note', crmSaveNote: 'Save note' },
