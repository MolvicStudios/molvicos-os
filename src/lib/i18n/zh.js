export default {
	...
	apps: {
		...
		prospectly: { name: 'Prospectly', desc: 'B2B AI 营销', tabFinder: '查找', tabIcp: 'ICP', tabEmails: '邮件', tabFollowup: '跟进', tabScript: '电话脚本', tabObjections: '异议处理', tabLinkedin: 'LinkedIn', tabSaved: '已保存' },
		aiworksuite: { name: 'AIWorkSuite', desc: '自由职业者生产力', teams: 'AI团队', invoice: '发票', proposal: '提案', contract: '合同', time: '时间', rate: '费率', crm: 'CRM', teamName: '团队名称', teamProject: '项目背景', teamProjectPh: '描述这个团队将要处理的项目...', createAITeam: '创建AI团队', detectingRoles: '检测角色中...', openChat: '打开团队聊天', messageTeam: '发送消息给团队...', agentsThinking: 'AI代理正在思考...', teamsEmpty: '创建你的第一个AI团队开始。', clientName: '客户名称', services: '提供的服务', totalAmount: '总金额', dueDate: '到期日', generate: '生成', projectDesc: '项目描述', budget: '预算范围', timeline: '时间线', projectScope: '项目 / 范围', ratePayment: '费率 / 付款', scopeNotes: '范围注释', annualIncome: '期望年收入', billableWeeks: '计费周数/年', billableHours: '计费小时/周', overheadPct: '间接费用 %（税、工具...）', calculateRate: '计算费率', copy: '复制', crmNewClient: '新客户', crmClientName: '姓名', crmClientCompany: '公司', crmClientEmail: '邮箱', crmClientPhone: '电话', crmClientNotes: '备注', crmPipeline: '销售管道', crmStageNew: '新客户', crmStageContacted: '已联系', crmStageQualified: '已筛选', crmStageProposal: '已报价', crmStageNegotiation: '谈判中', crmStageWon: '已成交', crmStageLost: '已流失', crmNoClients: '暂无客户。创建你的第一个客户开始。', crmChatPlaceholder: '询问关于此客户...', crmChatTitle: 'AI聊天', crmTabData: '数据', crmTabProposals: '提案', crmDeleteConfirm: '删除此客户？', crmMarkWon: '标记为成交', crmMarkLost: '标记为流失', crmAddNote: '添加备注', crmSaveNote: '保存备注' },
