export default {
	...
	apps: {
		...
		aiworksuite: { name: 'AIWorkSuite', desc: 'Freelancer-Produktivität', teams: 'KI-Teams', invoice: 'Rechnung', proposal: 'Angebot', contract: 'Vertrag', time: 'Zeit', rate: 'Tarif', crm: 'CRM', teamName: 'Teamname', teamProject: 'Projektkontext', teamProjectPh: 'Beschreibe das Projekt für dieses Team...', createAITeam: 'KI-Team erstellen', detectingRoles: 'Rollen erkennen...', openChat: 'Team-Chat öffnen', messageTeam: 'Nachricht an das Team...', agentsThinking: 'Agenten denken nach...', teamsEmpty: 'Erstelle dein erstes KI-Team, um zu beginnen.', clientName: 'Kundenname', services: 'Erbrachte Leistungen', totalAmount: 'Gesamtbetrag', dueDate: 'Fälligkeitsdatum', generate: 'Generieren', projectDesc: 'Projektbeschreibung', budget: 'Budgetrahmen', timeline: 'Zeitrahmen', projectScope: 'Projekt / Umfang', ratePayment: 'Tarif / Zahlung', scopeNotes: 'Umfangsnotizen', annualIncome: 'Gewünschtes Jahreseinkommen', billableWeeks: 'Abrechnungswochen/Jahr', billableHours: 'Abrechenbare Stunden/Woche', overheadPct: 'Gemeinkosten % (Steuern, Tools...)', calculateRate: 'Tarif berechnen', copy: 'Kopieren', crmNewClient: 'Neuer Kunde', crmClientName: 'Name', crmClientCompany: 'Unternehmen', crmClientEmail: 'E-Mail', crmClientPhone: 'Telefon', crmClientNotes: 'Notizen', crmPipeline: 'Pipeline', crmStageNew: 'Neu', crmStageContacted: 'Kontaktiert', crmStageQualified: 'Qualifiziert', crmStageProposal: 'Angebot', crmStageNegotiation: 'Verhandlung', crmStageWon: 'Gewonnen', crmStageLost: 'Verloren', crmNoClients: 'Noch keine Kunden. Erstelle deinen ersten Kunden.', crmChatPlaceholder: 'Frage zu diesem Kunden...', crmChatTitle: 'KI-Chat', crmTabData: 'Daten', crmTabProposals: 'Angebote', crmDeleteConfirm: 'Diesen Kunden löschen?', crmMarkWon: 'Als gewonnen markieren', crmMarkLost: 'Als verloren markieren', crmAddNote: 'Notiz hinzufügen', crmSaveNote: 'Notiz speichern' },
